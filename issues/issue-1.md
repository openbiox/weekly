...
我发布该周刊的驱动因素有两个：一是受到阮一峰《科技爱好者周刊》的影响，我常常能在其发布的内容中找到新颖有趣或值得思考的内容；二是处理浏览器不断增加的标签列表的焦虑感。我时常通过浏览器收藏非常不错的资源、文章，其中很多没看就忘记了，但我累积的内容确越来越多。
...
从个人的经历来看，生信主要有3大块内容，或者说它几本是由3个学科交叉形成的新的科学。
